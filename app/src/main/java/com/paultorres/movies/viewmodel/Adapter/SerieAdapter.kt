...
//class SerieAdapter() : PagingDataAdapter<MoviesModel, SerieAdapter.MovieViewHolder>(COMPARATOR) {
class SerieAdapter(private val onCLickListener: (MoviesEntity) -> Unit) :
    PagingDataAdapter<MoviesEntity, SerieAdapter.MovieViewHolder>(
        COMPARATOR
    ) {
